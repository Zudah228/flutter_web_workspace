...
final firebaseFunctionsProvider = Provider((_) =>
    FirebaseFunctionsRepository(FirebaseFunctions.instanceFor(region: 'asia-northeast1')),);
...
class FirebaseFunctionsRepository {
  ...
  Future<T> callable<T>(String name, {
